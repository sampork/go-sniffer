...
func TestDeps(t *testing.T) {
	...
	t.Run("NoPostgres", func(t *testing.T) {
		...
		assert.Contains(t, diff, "github.com/40t/go-sniffer/plugSrc/mongodb/build/FerretDB-internal/backends/postgresql")
	...
	t.Run("NoSqlite", func(t *testing.T) {
		...
		assert.Contains(t, diff, "github.com/40t/go-sniffer/plugSrc/mongodb/build/FerretDB-internal/backends/sqlite")
